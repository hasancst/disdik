...
<div class="content">
    <div class="container">
        <h4 class="mb-sm heading-primary"><strong>Informasi Pelayanan</strong></h4>
                        ...
                        <div class="row">
                            <div class="col-md-2" style="text-align: center;">
                                <div class="post-image">
                                    <a class="text-dark" href="<?= base_url('info/' . $item['id']) ?>"">
                            ...
                            <div class="col-md-10">
                                <div class="post-content">
                                    <h5 class="mt-xs mb-xs beritaberandajudul">
                                        <a class="text-dark" href="<?= base_url('info/' . $item['id']) ?>" title="<?= $item['post_title'] ?>"><?= $item['post_title'] ?></a>
                                    </h5>
