...
<div class="content">
    <div class="container">
        <div class="row pt-2">
            <div class="col-md-9">
                <div class="">
                    <h4 class="mb-sm"><strong> Pojok IT - <?= $title ?></strong></h4>
                    <p><i class="fas fa-calendar"></i> <?= $created ?> <i class="fas fa-user"></i> <?= $author ?></p>
                </div>
                <div class="p-2">
                    <img class="img-responsive" style="width: 30vw;" src="<?= base_url('Assets/post/' . $img) ?>" alt="pojokit Utama">
                    <?= $content ?>
                </div>
            </div>
            <div class="col-md-3">
                            ...
                            <?php foreach ($pojokit as $key => $item) { ?>
                                <div class="m-2 pt-2" style="border-bottom: ridge;">
                                    <a href="<?= base_url('pojokit/' . $item['id']) ?>">
                                        <h6 class="mt-xs mb-xs pojokitberandajudul"><a class="text-primary" href="<?= base_url('pojokit/' . $item['id']) ?>" title="<?= $item['post_title'] ?>"><?= $item['post_title'] ?></a></h6>
